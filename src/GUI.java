...
public abstract class GUI {
	...
	protected abstract void onSliderChanged(ChangeEvent e);
	...
	public int[] getLightIntensity() {
		return new int[] { intensity.getValue(), intensity.getValue(), intensity.getValue() };
	}
	...
	private boolean wireframeDraw = false;
	...
	private final JSlider intensity = new JSlider(JSlider.HORIZONTAL, 0, 255, 128);
	
	private final JSlider rotationX = new JSlider(JSlider.HORIZONTAL, 0, 359, 0);
	private final JSlider rotationY = new JSlider(JSlider.HORIZONTAL, 0, 359, 0);
	private final JSlider rotationZ = new JSlider(JSlider.HORIZONTAL, 0, 359, 0);
	
	private final JButton wireframe = new JButton("Wireframe OFF");
	...
	private void initialise() {
		...
		JPanel intensityJP = new JPanel();
		intensityJP.setLayout(new BoxLayout(intensityJP, BoxLayout.PAGE_AXIS));
		intensityJP.setBorder(BorderFactory.createTitledBorder("Itensity Light"));
		intensityJP.add(intensity);
		...
		JPanel rotationJP = new JPanel();
		rotationJP.setLayout(new BoxLayout(rotationJP, BoxLayout.PAGE_AXIS));
		rotationJP.setBorder(BorderFactory.createTitledBorder("Rotation"));
		rotationJP.add(new JLabel("X"));
		rotationJP.add(rotationX);
		rotationJP.add(new JLabel("Y"));
		rotationJP.add(rotationY);
		rotationJP.add(new JLabel("Z"));
		rotationJP.add(rotationZ);
		...
		JPanel wireframeJP = new JPanel(new BorderLayout());
		wireframeJP.setMaximumSize(new Dimension(1000, 25));
		wireframeJP.setPreferredSize(new Dimension(1000, 25));
		wireframeJP.add(wireframe, BorderLayout.CENTER);
		...
		controls.add(intensityJP);
		controls.add(rotationJP);
		controls.add(Box.createRigidArea(new Dimension(0, 15)));
		controls.add(wireframeJP);
		...
		frame.pack();
		frame.setTitle("(>^-^)> Prashant's 3D Renderer Pipeline <(^-^<)");
